...
extern "C" bool QUBIC_VERIFY_EXPORT verify_message(const unsigned char *publicKey, const unsigned char *message, const uint64_t messageSize, const unsigned char *signature);
